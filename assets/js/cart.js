...
stockElements.forEach(element => {
  ...
  let product = element.getAttribute('data-product'); // récupère le produit associé à l'élément de stock
  let addToCartButton = document.querySelector(`.add-to-cart[data-product="${product}"]`);  // récupère bouton associé à ce produit spécifique
